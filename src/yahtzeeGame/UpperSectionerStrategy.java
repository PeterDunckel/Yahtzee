...
public class UpperSectionerStrategy implements Strategy {
	...
	public int pickCategory(Die[] dice) {
		...
		if(!categoryIsSelected && indexOfCategory == 0){
	...
	public static void main(String[] args) {
		...
		upperSectioner.pickCategory(dice);
		
		//System.out.println(picked);
		
		dice[0].setRollValue(2);
		dice[1].setRollValue(2);
		dice[2].setRollValue(4);
		dice[3].setRollValue(6);
